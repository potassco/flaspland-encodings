...
queue = ['results/flatland-instances/clingo-latest-base/toy-env-01/run1/start.sh','results/flatland-instances/clingo-latest-base/toy-env-02/run1/start.sh','results/flatland-instances/clingo-latest-base/toy-env-03/run1/start.sh']
